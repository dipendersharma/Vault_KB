...
:::(Error)
![98-983834_torchlight-help-icon-help-icon](https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/98-983834_torchlight-help-icon-help-icon.png){height="30px" width="30px"}

**Help & feedback**

[Edit](https://knowledgebase.autorabit.com/docs/release-notes-216){target="_blank"} this page to fix an error or add an improvement in a merge request.
Create an issue to suggest an improvement to this page.
Show and post comments to review and give feedback about this page.

If you didn't find what you were looking for, [search the docs](https://knowledgebase.autorabit.com/docs/release-notes-216){target="_blank"}.

If you want help with something specific and could use community support, post on the [GitLab forum](https://knowledgebase.autorabit.com/docs/release-notes-216).

For problems setting up or using this feature (depending on your GitLab subscription).

[Request Support](https://knowledgebase.autorabit.com/docs/release-notes-216){target="_blank"}
:::
